...
class PDF(FPDF):
    def header(self):
        ...
        self.cell(0, 10, 'Comparative Regression Report', 0, 1, 'C')
...
def make_report():
    st.title("Generate Comparative Report")
    ...
    if st.button("Download Report"):
        ...
        pdf.output("comparative_regression_report.pdf")
        with open("comparative_regression_report.pdf", "rb") as f:
            st.download_button(label="Download PDF", data=f, file_name="comparative_regression_report.pdf")
